...
export const regionColors: colorPerYear[] = [
    {year: 0, color: "#606060"},     // Gray (default)
    {year: 1, color: "#000000"},     // Black (default)
    {year: 2015, color: "#8B0000"},  // Dark Red
    {year: 2016, color: "#CC5500"},  // Dark Orange
    {year: 2017, color: "#A0522D"},  // Sienna (brown-orange)
    {year: 2018, color: "#556B2F"},  // Dark Olive Green
    {year: 2019, color: "#2F4F4F"},  // Dark Slate Gray
    {year: 2020, color: "#008080"},  // Teal
    {year: 2021, color: "#191970"},  // Midnight Blue
    {year: 2022, color: "#4B0082"},  // Indigo
    {year: 2023, color: "#663399"},  // Rebecca Purple
    {year: 2024, color: "#8B008B"},  // Dark Magenta
    {year: 2025, color: "#9932CC"},  // Dark Orchid
    {year: 2026, color: "#6A0572"}   // Dark Purple
]
...
export const GOOGLE_MAIN_URL = 'https://www.google.com/search';
...
export const HELP_REGION = 'THIS BUTTON OPENS THE MENU TO CHANGE THE CURRENTLY DISPLAYED REGION FOR THE SELECTED CATEGORY. HIGHLIGHTING OF REGIONS CAN BE ENABLED IN THE SETTINGS.';
...
export const HELP_SETTINGS = 'THIS BUTTON OPENS THE SETTINGS MENU, WHERE GENERAL APP-SETTINGS LIKE HIGH-CONTRAST-MODE AND REGION HIGHLIGHTING CAN BE ENABLED.';
